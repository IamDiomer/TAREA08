...
public class Halo extends Comics {
    private String personajePrincipal;
    private String autor;
    private String editorial;

    public Halo(String titulo, int numPaginas, int anioPublicacion, String personajePrincipal, String autor, String editorial) {
    ...
    @Override
    public void leer() {
        System.out.println("Leyendo el cómic de Halo");
    }
}
